const GameDownUrlIos = "itms-services://?action=download-manifest&url=https://kh109gm.kkd666.com/xkby/xkby.plist"; // iOS
const GameDownUrlAndroid = "https://kh109gm.kkd666.com/xkby/xingkongbuyu.apk"; // Android

const TITLE = "星空捕鱼"; // 当前名字
const DATE = "2024-10-30"; // 更新时间
const VERSION = "2.0.24.9(build 1)"; // 当前版本
